...
int main() {
    ...
    vector< vector<double> > X_train = Load_State(Data_Folder + "train_states.txt");
    vector< vector<double> > X_test  = Load_State(Data_Folder + "test_states.txt");
    vector< string > Y_train = Load_Label(Data_Folder + "train_labels.txt");
    vector< string > Y_test  = Load_Label(Data_Folder + "test_labels.txt");
